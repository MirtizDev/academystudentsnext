...
function NavDarkResponsive() {
  return (
    <Link className={classes["navdark__logo-wrap"]} href='/' style={{textDecoration:'none'}} id='start1'>
        <Image src='/images/aclogo.png' alt='academy students logo' className={classes.navdark__logo} width={60} height={49}/>
